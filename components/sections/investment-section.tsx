      ...
      <div className="bg-gradient-to-r from-yellow-50 to-orange-50 border border-yellow-200 rounded-xl p-6 mb-8">
        ...
        <div className="bg-white rounded-lg p-4 border border-yellow-300">
          <p className="text-gray-700 leading-relaxed">
            يسعدنا أن نقدم لسيادتكم هذه الفرصة الاستثمارية المدروسة بعناية فائقة. نحن واثقون من أن هذا المشروع سيحقق
            عوائد مجزية ومستدامة بإذن الله، ونتطلع إلى شراكة ناجحة تحت قيادتكم الحكيمة وتوجيهاتكم القيمة.
          </p>
          <div className="mt-3 flex items-center gap-2 text-sm text-orange-700">
            <Handshake className="w-4 h-4" />
            <span className="font-semibold">نتشرف بثقتكم ونتعهد بتحقيق توقعاتكم</span>
          </div>
        </div>
      </div>
